...
public class Command
{
     ...
     *                  was not recognised.
     * @param secondWord The second word of the command.113
     */
    public Command(String firstWord, String secondWord, String terceraPalabra)
    {
    ...
    /**
     * @devuelve la tercera palabra.113
     */
